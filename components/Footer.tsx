...
export default function Footer() {
    return (
        <div className='bg-white uppercase p-10 md:p-20 text-secondary'>
                ...
                <div className="flex flex-col lg:flex-row justify-between py-3 items-start lg:items-center gap-10">
                    ...
                    <div className="text-center lg:text-left">
                        <div className="mb-5">
                            ...
                            <span className='lowercase text-xl text-[#808080] block sm:inline'>address</span>
                        </div>
                        <div className="">
                            <h3 className='text-2xl'>Say hello</h3>
                            <span className='lowercase text-xl text-[#808080] block sm:inline'>hello@creativebaxa.com</span>
                        </div>
                    </div>
                        ...
                        <div className="flex flex-col items-center lg:items-end">
                            {navLinks.map((item, index) => (
                                <div className='pb-2' key={index}>
                                    <Link className='text-xl text-[#808080] hover:text-primary transition' href={item.link}>{item.title}</Link>
                                </div>
                            ))}
                        </div>
